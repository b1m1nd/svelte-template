import { _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, f as _createClass, S as SvelteComponentDev, v as validate_slots, g as element, t as text, h as claim_element, j as children, k as claim_text, l as detach_dev, m as attr_dev, n as add_location, o as insert_dev, p as append_dev, q as listen_dev, r as _slicedToArray, u as set_data_dev, w as noop, x as space, y as create_component, z as query_selector_all, A as claim_space, B as claim_component, C as mount_component, D as transition_in, E as transition_out, F as destroy_component } from './client.43cf75fe.js';
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(button, file, 10, 0, 205);
    },
...
function create_else_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      add_location(p, file$1, 21, 60, 591);
    },
    m: function mount(target, anchor) {
...
function create_if_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      attr_dev(p, "class", "test svelte-u0k2wk");
      add_location(p, file$1, 21, 21, 552);
    },
    m: function mount(target, anchor) {
      insert_dev(target, p, anchor);
      append_dev(p, t);
...
function create_fragment$1(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      var head_nodes = query_selector_all("[data-svelte=\"svelte-1mmcm6n\"]", document.head);
    ...
    h: function hydrate() {
      ...
      add_location(h1, file$1, 10, 0, 224);
      ...
      add_location(img0, file$1, 16, 6, 374);
      add_location(figcaption0, file$1, 17, 6, 436);
      attr_dev(figure0, "class", "svelte-u0k2wk");
      add_location(figure0, file$1, 14, 4, 297);
      attr_dev(div0, "class", "card");
      add_location(div0, file$1, 13, 2, 273);
      ...
      add_location(img1, file$1, 28, 6, 747);
      attr_dev(strong, "class", "svelte-u0k2wk");
      add_location(strong, file$1, 32, 10, 874);
      attr_dev(p, "class", "svelte-u0k2wk");
      add_location(p, file$1, 30, 8, 831);
      add_location(figcaption1, file$1, 29, 6, 809);
      attr_dev(figure1, "class", "svelte-u0k2wk");
      add_location(figure1, file$1, 26, 4, 689);
      attr_dev(div1, "class", "card");
      add_location(div1, file$1, 25, 2, 665);
      attr_dev(div2, "class", "card");
      add_location(div2, file$1, 38, 2, 985);
      attr_dev(div3, "class", "grid svelte-u0k2wk");
      add_location(div3, file$1, 11, 0, 249);
    },
    m: function mount(target, anchor) {
