import { _ as _inherits, a as _getPrototypeOf, b as _possibleConstructorReturn, c as _classCallCheck, i as init, s as safe_not_equal, d as _assertThisInitialized, e as dispatch_dev, f as _createClass, S as SvelteComponentDev, R as validate_each_argument, v as validate_slots, g as element, t as text, h as claim_element, j as children, k as claim_text, l as detach_dev, m as attr_dev, n as add_location, o as insert_dev, p as append_dev, u as set_data_dev, x as space, z as query_selector_all, A as claim_space, r as _slicedToArray, w as noop, V as destroy_each } from './client.7554480f.js';
...
function create_each_block(ctx) {
  ...
  var block = {
    ...
    h: function hydrate() {
      ...
      /*post*/
      ctx[1].slug);
      add_location(a, file, 32, 6, 1019);
      add_location(li, file, 32, 2, 1015);
    },
...
function create_fragment(ctx) {
  ...
  var block = {
    ...
    l: function claim(nodes) {
      var head_nodes = query_selector_all("[data-svelte=\"svelte-d6o0bs\"]", document.head);
    ...
    h: function hydrate() {
      document.title = "Blog";
      add_location(h1, file, 24, 0, 738);
      attr_dev(ul, "class", "svelte-1k69szu");
      add_location(ul, file, 26, 0, 763);
    },
    m: function mount(target, anchor) {
